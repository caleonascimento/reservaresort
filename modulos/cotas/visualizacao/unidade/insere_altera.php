 					...
 					<div class="card-body">
										...
										<div class="row form-group">
											<div class="col-lg-4">
												...
												<input class="form-control" type='text' id='Tipo' placeholder='Tipo' name='fTipo'  required   value='<?php echo ($oUnidade) ? $oUnidade->getTipo() : ""; ?>' title="Este campo é obrigatório." />
											</div>
										</div>
										<div class="row form-group">
											<div class="col-lg-4">
												<label class="col-form-label" for="Descricao">Descricao:<span class="required">*</span></label>
												<input class="form-control" type='text' id='Descricao' placeholder='Descricao' name='fDescricao'  required   value='<?php echo ($oUnidade) ? $oUnidade->getDescricao() : ""; ?>' title="Este campo é obrigatório." />
											</div>
										</div>
										<div class="row form-group">
											<div class="col-lg-4">
												<label class="col-form-label" for="Lotacao">Lotacao:<span class="required">*</span></label>
												<input class="form-control" type='text' id='Lotacao' placeholder='Lotacao' name='fLotacao'  required  onKeyPress="TodosNumero(event);" value='<?php echo ($oUnidade) ? $oUnidade->getLotacao() : ""; ?>' title="Este campo é obrigatório." />
											</div>
										</div>
										<div class="row form-group">
											<div class="col-lg-4">

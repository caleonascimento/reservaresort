...
<section class="body-sign">
    <div class="center-sign">
        ...
        <div class="panel card-sign">
            ...
            <div class="card-body">
                <form action="login.php?action=processaLogin" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="fLogin" id="Login" class="form-control form-control-lg" tabindex="1">
                    ...
                    <div class="form-group mb-3">
                        <div class="clearfix">
                            ...
                            <a tabindex="3" href="login.php?action=resetSenha" class="float-right">Esqueceu a senha?</a>
                        </div>
                        <div class="input-group">
                            <input name="fSenha" id="Senha" type="password" class="form-control form-control-lg" tabindex="2"/>
                            <span class="input-group-append">
                                <span class="input-group-text">
